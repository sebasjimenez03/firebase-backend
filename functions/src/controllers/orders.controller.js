...
function httpError(res, e, fallback = 500) {
  ...
  console.error('GET /api/orders error:', { code, message: e?.message, stack: e?.stack });
...
async function listOrdersByShop(req, res) {
  try {
...
module.exports = { getAllOrders, getOrder, createOrder, listOrdersByShop};
